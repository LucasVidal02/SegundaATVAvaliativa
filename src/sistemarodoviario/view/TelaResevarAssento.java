...
public class TelaResevarAssento extends javax.swing.JFrame {
    ...
    private void jButtonSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSalvarActionPerformed
        ...
        try {
            ...
            Onibus onibus = Onibus.getInstance();
            onibus.setRota(onibusrotas);

            sucesso = onibusControler2.resevarAssento(onibus);
            this.jButtonLimparActionPerformed(evt);
            if (sucesso == true) {
                Assento assento = Assento.getInstance();
                assento.setLugar(lugar);
                assentoControler2.adicionarAssento(assento);
